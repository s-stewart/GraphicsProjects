...
void setup() {
  ...
  P.loadPts("data/goodpts2");  // loads saved model from file
...
void draw() {
  ...
  pushMatrix();   // to ensure that we can restore the standard view before writing on the canvas
   ...
   for(int i=0; i<num_vert-1; i++) // run loop for number of edges in a curve
   {
     ...
     //show(mApt(C1, C2, mA1.G[mA1.nv-1]),2); // to see connection to closest point on curves
   }   
...
String title ="6491 P2 2015: Medial Axis", name ="Ashish and Seth",
